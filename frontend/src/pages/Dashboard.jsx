      ...
      <header className="sticky top-0 z-50 w-full border-b border-border-light/80 dark:border-border-dark/60 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-xl">
        <div className="px-6 md:px-10 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 sm:gap-6 shrink-0">
            ...
            {/* Notifications */}
            <button className="relative text-muted-light hover:text-primary transition-colors dark:text-muted-dark">
              <span className="material-symbols-outlined">notifications</span>
              <span className="absolute top-0 right-0 size-2 bg-red-500 rounded-full border-2 border-background-light dark:border-background-dark"></span>
            </button>
            ...
            {/* User Avatar */}
            <div className="size-9 rounded-full bg-primary/20 border-2 border-white dark:border-gray-700 flex items-center justify-center text-primary font-bold shadow-md cursor-pointer">
