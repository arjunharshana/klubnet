...
const Loader = () => {
  return (
    <StyledWrapper className="flex items-center justify-center w-full h-full min-h-[50vh]">
...
const StyledWrapper = styled.div`
  ...
  .loadingspinner div {
    ...
    background: #7943a0; /* <-- Changed to KlubNet Purple */
    border: none;
    border-radius: 4px; /* Slightly more rounded for a modern look */
    width: var(--square);
    height: var(--square);
    position: absolute;
    padding: 0px;
